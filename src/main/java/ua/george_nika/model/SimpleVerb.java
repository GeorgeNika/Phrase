...
public class SimpleVerb extends AbstractEntity{
    ...
    SimpleVerb(){
        ...
        addEntity("понимаю","מבין","мевин");
        addEntity("сижу","יושב","йошев");
        ...
        addEntity("навещаю","מבקר","мевакер");
        addEntity("знаю","מכיר","макир");
        addEntity("подаю","מגיש","магишь");
        addEntity("варю еду","מבשל","мевашель");
        addEntity("моюсь","מתרחץ","митрахец");
        addEntity("играюсь","משחק","месахек");
        addEntity("поворачиваюсь","פונה","поне");

        addEntity("кладу","שם","сам");
        addEntity("встаю","קם","кам");
        addEntity("одеваюся","מתלבש","митлабеш");
        addEntity("бреюсь","מתגלח","митгалеах");
        addEntity("разогреваю","מחמם","мехамем");
        addEntity("бегаю","רץ","рац");
        addEntity("слушаю","שומע","шоме");
        addEntity("думаю","חושב","хошев");
        addEntity("стираю","מכבס","мехабес");
        addEntity("записываю","רושם","рошем");
