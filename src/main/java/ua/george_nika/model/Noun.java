...
public class Noun extends AbstractEntity {
    ...
    Noun() {
        ...
        addEntity("дедушка", "סבא", "саба");
        addEntity("товарищь", "ידיד", "ядид");
        addEntity("парень", "בחור", "бахур");
